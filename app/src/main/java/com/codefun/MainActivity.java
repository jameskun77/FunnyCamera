...
import com.codefun.camera.Camera2FrameCallback;
import com.codefun.camera.Camera2Wrapper;

import java.util.ArrayList;
import java.util.List;

import static com.codefun.render.ByteFlowRender.IMAGE_FORMAT_I420;

public class MainActivity extends BaseRenderActivity implements View.OnClickListener, Camera2FrameCallback {
    ...
    public void onPreviewFrame(byte[] data, int width, int height) {
        ...
        mGLByteFlowRender.setRenderFrame(IMAGE_FORMAT_I420, data, width, height);
        mGLByteFlowRender.requestRender();
    }
    ...
    private void initView(){
        ...
        mGLByteFlowRender.init(mGLSurfaceView);
        mGLByteFlowRender.loadShaderFromAssetsFile("baseFragmentShader.glsl",getResources());
    ...
    public static class MyRecyclerViewAdapter extends
            RecyclerView.Adapter<MyRecyclerViewAdapter.MyViewHolder> implements View.OnClickListener{
